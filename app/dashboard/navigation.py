...
from .tasks_dashboard import tasks_dashboard_page
...
def show_navigation():
    ...
    pages = [
        ...
        st.Page(tasks_dashboard_page, title=f"Tasks ({get_user_active_task_count()})"),
    ...
    st.sidebar.toggle(
        "Allow quick complete without results",
        key="allow_quick_complete",
        help="Skip results dialog for faster task completion"
    )
